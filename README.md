...
### Links
-  [Solution URL:](https://github.com/krishna-saini/CSS-p10-interior-design-landing-Page)
-  [Live Site URL:](https://interior-desing-landing-page-by-krishna-saini.netlify.app/)
...
### What I learned
I got an idea of how to make background image responsive. The trick is Use the background-size property to encompass the viewport. Give this property a cover value that will tell a browser to scale the background image’s heights and width so that they always remain equal to or greater than the height/width of the device viewport.
